...
class CheckPointManager(object):
    ...
    def __init__(self, save_path: str = None, max_to_keep=5, keep_checkpoint_every_n_hours=10000.0):
        ...
        self._save_path = save_path + '_{}.pth' if save_path is not None else None
    ...
    def _save_checkpoint(self, step, model, optimizer, score):
        ...
        self._logger.info('Current val score is {:.3g} while the best val score is {:.3g}'.format(score, self._best_score))
        ...
        if score > self._best_score:
            ...
            self._logger.info('Checkpoint is current best')

    def _remove_old_checkpoints(self):
        """ Check the buffer of checkpoints, if the number of models is more than max_to_keep,
            and the savetime of last model is not old enough, then delete it.
        """
    ...
    def load(self, save_path, model: torch.nn.Module = None, optimizer: Optimizer = None):
        ...
        if os.path.isdir(save_path):
            save_path = os.path.join(save_path, 'model_best.pth')
